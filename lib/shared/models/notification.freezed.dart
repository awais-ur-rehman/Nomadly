...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, title: $title, body: $body, type: $type, createdAt: $createdAt, isRead: $isRead, data: $data)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, body, type, createdAt, isRead, data);
